# Ontolog implementation plans

Chapter-based implementation plans for the Ontolog library. Update these as chapters land.

| Plan | Description |
|------|-------------|
| [IMPLEMENTATION_PLAN.md](IMPLEMENTATION_PLAN.md) | Chapter tracker and high-level acceptance criteria |
| [unified.plan.md](unified.plan.md) | Full unified plan (architecture, corpora, all chapters) |
...
| [chapter_8.plan.md](chapter_8.plan.md) | Detailed TDD implementation plan for Chapter 8 |

## Chapter status

| Chapter | Status | Plan |
|---------|--------|------|
| 0 — Scaffold | Complete | [unified.plan.md](unified.plan.md#chapter-0--repository-scaffold-and-engineering-baseline) |
...
| 8 — Export layer | Complete | [chapter_8.plan.md](chapter_8.plan.md) |
| 9–12 | Pending | [unified.plan.md](unified.plan.md) |
