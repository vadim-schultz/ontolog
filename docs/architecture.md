...
| Domain JSON | `export/domain_json.py` | Full domain model JSON |
| Evidence graph | `export/evidence_graph_export.py` | Evidence graph JSON |
| Full bundle | `export/full_bundle.py` | Domain model + graph + template summary |
